...
<!--Pour utiliser radiotray selector vous devez installer yad.sh. Ensuite extraire tous les fichiers dans le dossier --> /home/$USER/.local/share/radiotray/bookmarks\ selector/. Vous n'avez plus qu' à créer le raccourci de radiotray selector sur votre bureau. Nb. A chaque utilisation de radiotray selector vous êtes obligés de recharger à chaque fois les signets.
